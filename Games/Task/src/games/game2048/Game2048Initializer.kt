...
object RandomGame2048Initializer : Game2048Initializer<Int> {
    ...
    override fun nextValue(board: GameBoard<Int?>): Pair<Cell, Int>? {
        val emptyCellsList = board.getAllCells().filter { board[it] == null }
        return if(emptyCellsList.isEmpty()) null else emptyCellsList[Random.nextInt(emptyCellsList.size)] to generateRandomStartValue()
    }
}